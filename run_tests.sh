...
optimisations=("NO_OPTIMISATION" "CYCLE_OPTIMISATION" "AVX_OPTIMISATION" "ASM_CRC32_OPTIMISATION" "INL_ASM_CRC32_OPTIMISATION" "PRE_ALIGNEED_WORDS" "NOPRE_ALIGNEED_WORDS")
